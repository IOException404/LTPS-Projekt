  ...
  constructor() {
    this.mcFragen = [
      ...
      },
      {
        ...
        ans: [{txt:'A. 10.0.0.0/8', right:false, choosen:false  },  { txt:'B. 127.0.0.0/8', right: true, choosen:false }, { txt:'C. 169.255.0.0/16', right: false, choosen:false  }, { txt:'D. 172.16.0.0/12', right: false, choosen:false  }, { txt:'E. 192.168.0.0/16', right:true, choosen:false  }],
        info: "Die Antworten sind: A-D-E"
      }
    ]
   }
